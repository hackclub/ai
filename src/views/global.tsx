    ...
    <Layout title="Global Statistics">
      ...
      <div class="max-w-6xl mx-auto px-4 py-8">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          ...
          <StatCard value={globalStats.totalTokens?.toLocaleString() || 0} label="Total Tokens" />
          <StatCard value={globalStats.totalPromptTokens?.toLocaleString() || 0} label="Prompt Tokens" />
          <StatCard value={globalStats.totalCompletionTokens?.toLocaleString() || 0} label="Completion Tokens" />
        </div>
        ...
        {modelStats.length === 0 ? (
          ...
          <Table
            columns={[
              {
                header: 'Model',
                render: (row) => <span class="font-medium">{row.model || 'Unknown'}</span>,
              },
              {
                header: 'Requests',
              ...
              },
              {
                ...
                render: (row) => row.totalCompletionTokens?.toLocaleString() || 0,
              },
            ]}
            data={modelStats}
          />
