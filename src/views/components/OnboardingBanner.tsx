        ...
        <div class="p-6 sm:p-8 flex flex-col md:flex-row items-center gap-6 text-center md:text-left">
          ...
          <div class="flex-1">
            ...
            <p class="text-brand-text leading-relaxed max-w-2xl">
              ...
              learn how to integrate various models into your projects, as well as the
              <a href="https://docs.ai.hackclub.com/guide/rules.html" class="font-bold underline">rules you need to follow
                (incl. not using coding agents)</a>, check out our comprehensive documentation.
            </p>
          </div>
          <a
