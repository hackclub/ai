...
export const ModelSchema = type({
    ...
    "top_provider?": type({
        ...
        "is_moderated?": type("boolean").describe(
...
export const StatsSchema = type({
    totalRequests: type("number.integer").describe("The total number of requests"),
...
export const ChatCompletionResponseSchema = type({
    ...
    usage: type({
        ...
        "prompt_time?": type("number").describe("The time spent processing the prompt"),
